...
void stif_karp_perform64(t_stif_karp* x, t_object* dsp64, double** ins, long numins, double** outs, long numouts, long sampleframes,
...
void ext_main(void* p) {
	t_class* c
		= class_new("stif_karp~", (method)stif_karp_new, (method)stif_karp_free, (long)sizeof(t_stif_karp), 0L, A_DEFLONG, A_DEFLONG, 0);
