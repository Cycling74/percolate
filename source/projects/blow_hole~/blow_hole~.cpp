...
void blow_hole_perform64(t_blow_hole* x, t_object* dsp64, double** ins, long numins, double** outs, long numouts, long sampleframes,
...
void ext_main(void* p) {
	...
	t_class* c
		= class_new("blow_hole~", (method)blow_hole_new, (method)blow_hole_free, (long)sizeof(t_blow_hole), 0L, A_DEFLONG, A_DEFLONG, 0);
