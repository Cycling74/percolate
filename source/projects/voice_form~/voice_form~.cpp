...
void voice_form_perform64(t_voice_form* x, t_object* dsp64, double** ins, long numins, double** outs, long numouts, long sampleframes,
...
void ext_main(void* p) {
	t_class* c = class_new(
		"voice_form~", (method)voice_form_new, (method)voice_form_free, (long)sizeof(t_voice_form), 0L, A_DEFLONG, A_DEFLONG, 0);
