...
void sigcasey_perform64(
	t_sigcasey* x, t_object* dsp64, double** ins, long numins, double** outs, long numouts, long sampleframes, long flags, void* userparam);
void sigcasey_2perform64(
	t_sigcasey* x, t_object* dsp64, double** ins, long numins, double** outs, long numouts, long sampleframes, long flags, void* userparam);
...
void sigcasey_perform64(t_sigcasey* x, t_object* dsp64, double** ins, long numins, double** outs, long numouts, long sampleframes,
...
void sigcasey_2perform64(t_sigcasey* x, t_object* dsp64, double** ins, long numins, double** outs, long numouts, long sampleframes,
	long flags, void* userparam) {
