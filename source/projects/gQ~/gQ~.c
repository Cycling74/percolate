...
void gq_performMo64(
	t_gq* x, t_object* dsp64, double** ins, long numins, double** outs, long numouts, long sampleframes, long flags, void* userparam);
void gq_performSt64(
	t_gq* x, t_object* dsp64, double** ins, long numins, double** outs, long numouts, long sampleframes, long flags, void* userparam);
...
void gq_updatebank(t_gq* x, t_symbol* s, long argc, t_atom* argv) {
	...
	if (argc < 4)
		post("gQ: need 'bank cf bw mult type' to setbank");
