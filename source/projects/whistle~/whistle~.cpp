...
void whistle_perform64(t_whistle *x, t_object *dsp64, double **ins, long numins, double **outs, long numouts, long sampleframes, long flags, void *userparam);
...
void ext_main(void* p)
{
    ...
    class_addmethod(c, (method)whistle_noteoff, "noteoff", A_GIMME, 0);    class_dspinit(c);
