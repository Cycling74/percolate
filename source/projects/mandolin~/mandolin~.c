...
void mando_perform64(
	t_mando* x, t_object* dsp64, double** ins, long numins, double** outs, long numouts, long sampleframes, long flags, void* userparam);
...
void pluck(t_mando* x, float amplitude, float position) { /* this function gets interesting here, */
