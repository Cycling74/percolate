...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 321.0, 317.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 161.5, 501.0, 34.0, 23.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 23.0, 501.0, 34.0, 23.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 161.5, 466.0, 128.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "signal", "signal" ],
					"patching_rect" : [ 161.5, 427.0, 124.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "signal", "signal" ],
					"patching_rect" : [ 23.0, 466.0, 128.0, 23.0 ],
					"text" : "ifft~ 1024 1024 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "signal", "signal" ],
					"patching_rect" : [ 23.0, 427.0, 124.0, 23.0 ],
					"text" : "fft~ 1024 1024 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 161.5, 389.5, 34.0, 23.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 274.0, 317.0, 39.0, 23.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 274.0, 354.0, 57.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 23.0, 389.5, 34.0, 23.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 129.0, 317.0, 30.0, 23.0 ],
					"text" : "0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 101.0, 316.0, 21.0, 23.0 ],
					"text" : "0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 40.666668000000001, 316.0, 50.0, 23.0 ],
					"text" : "/ 1024."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 40.666668000000001, 282.0, 31.0, 23.0 ],
					"text" : "t i b"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 23.0, 245.0, 72.0, 23.0 ],
					"text" : "dspstate~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 161.5, 354.0, 76.0, 23.0 ],
					"text" : "cycle~ foo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 23.0, 354.0, 76.0, 23.0 ],
					"text" : "cycle~ foo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 384.5, 137.0, 64.0, 23.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 386.5, 201.0, 72.0, 23.0 ],
					"text" : "s wintype"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 23.0, 137.0, 71.0, 23.0 ],
					"text" : "r wintype"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 386.5, 168.5, 19.0, 23.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 413.0, 168.5, 19.0, 23.0 ],
					"text" : "2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 23.0, 201.0, 71.0, 23.0 ],
					"text" : "peek~ foo"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 106.0, 201.0, 91.0, 23.0 ],
					"text" : "buffer~ foo 50"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 23.0, 168.5, 90.0, 23.0 ],
					"text" : "gen25 512 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 208.0, 160.0, 171.0, 40.0 ],
					"text" : "• 1 is a hanning window, 2 is a hamming window..."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 296.5, 425.0, 106.0, 69.0 ],
					"text" : "do some cool frequency domain stuff here."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 250.5, 255.5, 104.0, 55.0 ],
					"text" : "• load in and play a soundfile"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 23.0, 543.042479999999955, 136.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 23.0, 601.042479999999955, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 62.0, 510.0, 65.0 ],
					"text" : "• gen25 -- takes an int to specify a hanning (1) or hamming (2) window. the object then computes the window function so you can peek~ it into a buffer~. arguments are buffer size (default 512) and offset into output buffer (default 0). you can change these with size N and offset N. ported from real-time cmix, by brad garton and dave topper.",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 385.0, 556.0, 140.0, 87.0 ],
					"pic" : "percolate.jpg"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 148.0, 648.0, 377.0, 21.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 283.5, 380.0, 47.5, 380.0 ],
					"order" : 1,
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 1 ],
					"midpoints" : [ 283.5, 382.0, 186.0, 382.0 ],
					"order" : 0,
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 138.5, 346.0, 228.0, 346.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 110.5, 346.0, 89.5, 346.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 50.166668000000001, 346.0, 171.0, 346.0 ],
					"order" : 0,
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 50.166668000000001, 346.0, 32.5, 346.0 ],
					"order" : 1,
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 62.166668000000001, 309.0, 138.5, 309.0 ],
					"order" : 0,
					"source" : [ "obj-18", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 62.166668000000001, 309.0, 110.5, 309.0 ],
					"order" : 1,
					"source" : [ "obj-18", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 1 ],
					"midpoints" : [ 171.0, 382.0, 186.0, 382.0 ],
					"order" : 0,
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 1 ],
					"midpoints" : [ 32.5, 382.0, 47.5, 382.0 ],
					"order" : 0,
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 171.0, 531.0, 32.5, 531.0 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 1 ],
					"midpoints" : [ 223.5, 457.0, 280.0, 457.0 ],
					"source" : [ "obj-6", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 1 ],
					"midpoints" : [ 85.0, 458.0, 141.5, 458.0 ],
					"source" : [ "obj-8", 1 ]
				}
