...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 23.0, 380.0, 61.0, 23.0 ],
					"text" : "*~ 0.99"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 23.0, 245.0, 38.0, 23.0 ],
					"text" : "mtof"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 23.0, 314.0, 61.0, 23.0 ],
					"text" : "phasor~"
				}
...
,
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 23.0, 215.0, 51.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 148.0, 245.0, 35.0, 23.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 354.0, 370.0, 45.0, 23.0 ],
					"text" : "s timb"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 148.0, 215.0, 47.0, 23.0 ],
					"text" : "r timb"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 354.0, 174.0, 120.0, 23.0 ],
					"text" : "0 0 1 1 2 0 3 -1 4 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 354.0, 202.0, 135.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 354.0, 230.0, 55.0, 23.0 ],
					"text" : "0 -1 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 354.0, 258.0, 55.0, 23.0 ],
					"text" : "0 1 1 -1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 354.0, 286.0, 98.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 354.0, 315.0, 120.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 353.0, 343.0, 178.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 148.0, 314.0, 52.0, 23.0 ],
					"text" : "set foo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 23.0, 348.0, 177.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 208.0, 314.0, 71.0, 23.0 ],
					"text" : "peek~ foo"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 353.0, 146.0, 98.0, 23.0 ],
					"text" : "buffer~ foo 186"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 208.0, 284.0, 98.0, 23.0 ],
					"text" : "gen24 8192 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 497.0, 202.0, 136.0, 112.0 ],
					"text" : "• list of times and amplitudes for breakpoint function (times are relative and will be rescaled to the size of the buffer)."
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 23.0, 418.042480000000012, 136.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 23.0, 476.042480000000012, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 488.0, 431.0, 140.0, 87.0 ],
					"pic" : "percolate.jpg"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 251.0, 523.0, 377.0, 21.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-25", 0 ],
					"midpoints" : [ 157.5, 343.0, 32.5, 343.0 ],
					"source" : [ "obj-5", 0 ]
				}
