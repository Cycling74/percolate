...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 19.0, 480.0, 136.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 19.0, 549.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 19.0, 77.0, 549.0, 65.0 ],
					"text" : "This class uses banded waveguide techniques to model a variety of sounds, including bowed bars, glasses, and bowls. For more information, see Essl, G. and Cook, P. \"Banded Waveguides: Towards Physical Modelling of Bar Percussion Instruments\", Proceedings of the 1999 International Computer Music Conference",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 19.0, 18.0, 428.0, 60.0 ],
					"text" : "Banded Waveguide",
					"textcolor" : [ 0.2, 0.2, 0.2, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 553.5, 480.0, 140.0, 87.0 ],
					"pic" : "percolate.jpg"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 318.5, 576.0, 383.0, 21.0 ],
					"text" : "by perry cook and gary scavone - ported to MSP by dan trueman"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 192.5, 500.0, 47.0, 27.0 ],
					"preset_data" : [ 						{
							"number" : 1,
							"data" : [ 6, "<invalid>", "gain~", "list", 109, 10.0, 5, "<invalid>", "number", "float", 92.0, 5, "<invalid>", "number", "float", 0.0, 5, "<invalid>", "number", "float", 125.0, 5, "<invalid>", "number", "float", 123.0, 5, "obj-27", "kslider", "int", 73, 5, "<invalid>", "number", "float", 70.0, 5, "<invalid>", "number", "float", 53.0, 5, "<invalid>", "number", "int", 2 ]
						}
, 						{
							"number" : 2,
							"data" : [ 6, "<invalid>", "gain~", "list", 115, 10.0, 5, "<invalid>", "number", "float", 92.0, 5, "<invalid>", "number", "float", 0.0, 5, "<invalid>", "number", "float", 125.0, 5, "<invalid>", "number", "float", 123.0, 5, "obj-27", "kslider", "int", 58, 5, "<invalid>", "number", "float", 70.0, 5, "<invalid>", "number", "float", 53.0, 5, "<invalid>", "number", "int", 3 ]
						}
, 						{
							"number" : 3,
							"data" : [ 6, "<invalid>", "gain~", "list", 115, 10.0, 5, "<invalid>", "number", "float", 92.0, 5, "<invalid>", "number", "float", 0.0, 5, "<invalid>", "number", "float", 125.0, 5, "<invalid>", "number", "float", 123.0, 5, "obj-27", "kslider", "int", 72, 5, "<invalid>", "number", "float", 70.0, 5, "<invalid>", "number", "float", 53.0, 5, "<invalid>", "number", "int", 1 ]
						}
, 						{
							"number" : 4,
							"data" : [ 6, "<invalid>", "gain~", "list", 109, 10.0, 5, "<invalid>", "number", "float", 91.0, 5, "<invalid>", "number", "float", 0.0, 5, "<invalid>", "number", "float", 122.0, 5, "<invalid>", "number", "float", 121.0, 5, "obj-27", "kslider", "int", 68, 5, "<invalid>", "number", "float", 69.0, 5, "<invalid>", "number", "float", 53.0, 5, "<invalid>", "number", "int", 2 ]
						}
 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 19.5, 364.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 19.5, 278.399999999999977, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 172.0, 334.0, 169.0, 83.0 ],
					"text" : "instrument type:\r   0. Uniform Bar\r   1. Tuned Bar\r   2. Glass Harmonica\r   3. Tibetan Bowl"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 172.0, 279.0, 88.0, 25.0 ],
					"text" : "set striking"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 364.0, 84.0, 23.0 ],
					"text" : "control 16 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 278.399999999999977, 84.0, 23.0 ],
					"text" : "control 64 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 172.0, 251.0, 96.0, 25.0 ],
					"text" : "bow velocity"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 172.0, 164.0, 50.0, 25.0 ],
					"text" : "gain"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 172.0, 223.0, 91.0, 25.0 ],
					"text" : "vibrato freq"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 172.0, 307.0, 137.0, 25.0 ],
					"text" : "bow motion"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 19.5, 192.599999999999994, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 192.599999999999994, 76.0, 23.0 ],
					"text" : "control 2 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 501.0, 295.0, 56.0, 23.0 ],
					"text" : "noteoff"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 389.0, 295.0, 96.0, 23.0 ],
					"text" : "noteon $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 389.0, 263.0, 74.0, 23.0 ],
					"text" : "pack 1. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 650.0, 210.0, 53.0, 23.0 ],
					"text" : "/ 127."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 389.0, 210.0, 41.0, 23.0 ],
					"text" : "mtof"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 389.0, 154.0, 280.0, 45.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 19.5, 249.799999999999983, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 19.5, 164.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 19.5, 221.199999999999989, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 19.5, 307.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 249.799999999999983, 91.0, 23.0 ],
					"text" : "control 128 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 164.0, 76.0, 23.0 ],
					"text" : "control 1 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 221.199999999999989, 83.0, 23.0 ],
					"text" : "control 11 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 307.0, 76.0, 23.0 ],
					"text" : "control 4 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 19.0, 441.5, 84.0, 23.0 ],
					"text" : "bandedWG~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 172.0, 193.0, 139.0, 25.0 ],
					"text" : "bow pressure"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-38", 0 ],
					"midpoints" : [ 510.5, 429.0, 114.0, 429.0, 114.0, 429.0, 28.5, 429.0 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-38", 0 ],
					"midpoints" : [ 398.5, 429.0, 114.0, 429.0, 114.0, 429.0, 28.5, 429.0 ],
					"source" : [ "obj-23", 0 ]
				}
