...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 198.0, 239.0, 131.0, 84.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 175.0, 207.0, 60.0, 23.0 ],
					"text" : "mix 4 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 101.0, 176.0, 46.0, 23.0 ],
					"text" : "loop 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 65.0, 176.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 14.0, 262.0, 69.0, 23.0 ],
					"text" : "PRC_rev~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 14.0, 176.0, 39.0, 23.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 14.0, 216.0, 52.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 238.0, 207.0, 51.0, 23.0 ],
					"text" : "T60 $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 175.0, 176.0, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 238.0, 176.0, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 14.0, 295.0, 136.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 14.0, 353.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Perry's simple reverberator class. This class is based on some of the famous Stanford/CCRMA reverbs (NRev, KipRev), which were based on the Chowning/Moorer/Schroeder reverberators using networks of simple allpass and comb delay filters. This class implements two series allpass units and two parallel comb filters.",
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 74.5, 203.0, 23.5, 203.0 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 110.5, 208.0, 23.5, 208.0 ],
					"source" : [ "obj-14", 0 ]
				}
