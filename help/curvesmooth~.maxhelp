...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 57.0, 469.0, 257.0, 98.0 ],
					"text" : "when it is set (default), the curvature will vary depending on how far the target it is from the current value. when this is set, and the coeffs are set to 1, the behavior of curvature~ is like rampsmooth~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 159.5, 405.5, 343.0, 54.0 ],
					"text" : "* follow mode: set this if you want to work outside [-1,1], or if you want the curvature to vary according to how far the target moves."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 135.5, 373.5, 161.0, 25.0 ],
					"text" : "* downcurve coefficient"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 135.5, 325.5, 338.5, 40.0 ],
					"text" : "* upcurve coefficient (1 => linear; >1 => exponential; <1 => log; max = 1000 (ints), min = 0.001, to the .001)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 135.5, 289.5, 127.0, 25.0 ],
					"text" : "* downcurve time"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 135.5, 254.5, 184.0, 25.0 ],
					"text" : "* upcurve time (ms, sort of)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 193.0, 116.0, 19.0, 23.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 191.0, 83.0, 64.0, 23.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 218.0, 116.0, 19.0, 23.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 30.0, 135.0, 87.0, 23.0 ],
					"text" : "metro 2000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 189.0, 110.0, 23.0 ],
					"text" : "expr $f1*0.25 - 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 30.0, 161.0, 69.0, 23.0 ],
					"text" : "random 8"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 124.0, 107.0, 53.0, 28.0 ],
					"preset_data" : [ 						{
							"number" : 1,
							"data" : [ 5, "obj-32", "number~", "list", 0.75, 5, "obj-31", "number", "float", 1000.0, 5, "obj-24", "number~", "list", -0.01, 5, "obj-16", "number", "float", 200.0, 5, "obj-15", "number", "float", 100.0, 5, "obj-14", "number", "float", 0.1, 5, "obj-13", "toggle", "int", 0, 5, "obj-4", "toggle", "int", 1 ]
						}
, 						{
							"number" : 2,
							"data" : [ 5, "obj-32", "number~", "list", -0.75, 5, "obj-31", "number", "float", 1000.0, 5, "obj-24", "number~", "list", -0.01, 5, "obj-16", "number", "float", 200.0, 5, "obj-15", "number", "float", 100.0, 5, "obj-14", "number", "float", 0.1, 5, "obj-13", "toggle", "int", 1, 5, "obj-4", "toggle", "int", 1 ]
						}
, 						{
							"number" : 3,
							"data" : [ 5, "obj-32", "number~", "list", 0.5, 5, "obj-31", "number", "float", 500.0, 5, "obj-24", "number~", "list", -0.01, 5, "obj-16", "number", "float", 500.0, 5, "obj-15", "number", "float", 1.0, 5, "obj-14", "number", "float", 1.0, 5, "obj-13", "toggle", "int", 1, 5, "obj-4", "toggle", "int", 1 ]
						}
, 						{
							"number" : 4,
							"data" : [ 5, "obj-32", "number~", "list", -0.75, 5, "obj-31", "number", "float", 200.0, 5, "obj-24", "number~", "list", -0.01, 5, "obj-16", "number", "float", 3000.0, 5, "obj-15", "number", "float", 0.01, 5, "obj-14", "number", "float", 1000.0, 5, "obj-13", "toggle", "int", 0, 5, "obj-4", "toggle", "int", 1 ]
						}
 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 130.0, 420.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 57.0, 373.5, 67.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 57.0, 334.0, 67.0, 23.0 ],
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 57.0, 289.5, 67.0, 23.0 ],
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 261.0, 639.0, 213.0, 88.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 57.0, 420.5, 61.0, 23.0 ],
					"text" : "mode $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 344.0, 535.0, 44.0, 23.0 ],
					"text" : "* 44.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 261.0, 535.0, 44.0, 23.0 ],
					"text" : "* 44.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 344.0, 563.0, 89.0, 23.0 ],
					"text" : "rampdown $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 261.0, 563.0, 73.0, 23.0 ],
					"text" : "rampup $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 261.0, 605.0, 97.0, 23.0 ],
					"text" : "rampsmooth~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 63.0, 605.0, 65.0, 23.0 ],
					"sig" : 0.0,
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 44.0, 639.0, 213.0, 88.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 83.0, 750.0, 96.0, 25.0 ],
					"text" : "• start audio"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 57.0, 254.5, 67.0, 23.0 ],
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 30.0, 220.0, 54.0, 23.0 ],
					"sig" : 0.0,
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 44.0, 563.0, 103.0, 23.0 ],
					"text" : "curvesmooth~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 738.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 62.0, 449.0, 36.0 ],
					"text" : "• curvesmooth~ is like rampsmooth~ except you can control the curvature of the smoothing function.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 3.0, 313.0, 60.0 ],
					"text" : "curvesmooth~",
					"textcolor" : [ 0.2, 0.2, 0.2, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 481.5, 681.0, 140.0, 87.0 ],
					"pic" : "percolate.jpg"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 382.5, 770.0, 239.0, 21.0 ],
					"text" : "• by dan trueman, princeton music dept."
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 66.5, 319.0, 353.5, 319.0 ],
					"order" : 0,
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 66.5, 282.0, 270.5, 282.0 ],
					"order" : 0,
					"source" : [ "obj-31", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-24", 0 ],
					"midpoints" : [ 39.5, 594.0, 270.5, 594.0 ],
					"order" : 0,
					"source" : [ "obj-32", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-33", 0 ],
					"midpoints" : [ 39.5, 555.0, 53.5, 555.0 ],
					"order" : 1,
					"source" : [ "obj-32", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 53.5, 594.0, 72.5, 594.0 ],
					"order" : 0,
					"source" : [ "obj-33", 0 ]
				}
