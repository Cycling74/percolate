...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0, 905.5, 45.0, 45.0 ]
				}
...
, 						{
							"number" : 15,
							"data" : [ 5, "obj-71", "number", "float", 65.406395000000003, 6, "<invalid>", "gain~", "list", 98, 10.0, 5, "obj-66", "number", "float", 0.43, 5, "obj-65", "number", "float", 49.0, 5, "obj-58", "number", "float", 1.0, 5, "obj-55", "number", "float", 1.0, 5, "obj-53", "number", "float", 0.01, 5, "obj-51", "number", "float", 69.295653999999999, 5, "obj-48", "number", "float", 73.416190999999998, 5, "<invalid>", "number", "float", 77.781745999999998, 5, "obj-42", "number", "float", 82.406891000000002, 5, "obj-39", "number", "float", 87.307060000000007, 5, "obj-36", "number", "int", 5, 5, "obj-34", "number", "float", 2.0, 5, "obj-33", "number", "float", 0.87, 5, "obj-31", "number", "float", 0.13, 5, "obj-29", "number", "float", 10.0, 5, "obj-25", "number", "int", 5, 5, "obj-20", "number", "float", 3.0, 5, "obj-19", "number", "float", 0.45, 5, "obj-14", "number", "float", 0.99, 5, "obj-13", "kslider", "int", 41, 5, "<invalid>", "toggle", "int", 1 ]
						}
 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 18.0, 324.0, 600.5, 23.0 ],
					"text" : "ublotar~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 723.5, 489.0, 210.0, 54.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 478.0, 903.0, 149.0, 50.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 163.400000000000091, 848.5, 114.0, 25.0 ],
					"text" : "turn up volume"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 68.400000000000091, 915.5, 79.0, 25.0 ],
					"text" : "start dsp"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 18.0, 855.5, 140.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 12.0, -28.0, 525.0, 123.75 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 279.400000000000091, 851.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "2",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 149.900000000000091, 918.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
