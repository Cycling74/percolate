...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 266.0, 463.042480000000012, 116.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 266.0, 396.042480000000012, 144.0, 25.0 ],
					"text" : "expansion threshold"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 266.0, 326.042480000000012, 130.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 266.0, 259.042480000000012, 158.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 208.5, 530.0, 52.0, 30.0 ],
					"preset_data" : [ 						{
							"number" : 1,
							"data" : [ 5, "obj-45", "live.gain~", "float", 0.0, 5, "obj-13", "umenu", "int", 0, 5, "obj-21", "flonum", "float", 0.5, 5, "obj-4", "flonum", "float", 0.01, 5, "obj-6", "flonum", "float", 1.0, 5, "obj-12", "flonum", "float", 1.0 ]
						}
 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 207.0, 464.042480000000012, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 207.0, 499.042480000000012, 75.0, 23.0 ],
					"text" : "expratio $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 207.0, 327.042480000000012, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 207.0, 362.042480000000012, 86.0, 23.0 ],
					"text" : "compratio $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 207.0, 397.042480000000012, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 207.0, 432.042480000000012, 86.0, 23.0 ],
					"text" : "expthresh $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 207.0, 149.042480000000012, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 207.0, 260.042480000000012, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 292.5, 499.042480000000012, 105.0, 23.0 ],
					"text" : "s vcompandmsg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 207.0, 295.042480000000012, 96.0, 23.0 ],
					"text" : "compthresh $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 23.0, 149.042480000000012, 82.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 23.0, 225.042480000000012, 82.0, 23.0 ],
					"text" : "selector~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 179.5, 149.042480000000012, 20.0, 23.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 155.5, 149.042480000000012, 20.0, 23.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 111.5, 149.042480000000012, 40.0, 23.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 111.5, 183.0, 80.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 23.0, 260.042480000000012, 171.0, 23.0 ],
					"text" : "pfft~ vcompandsub~ 4096 4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 23.0, 634.042479999999955, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 62.0, 552.0, 79.0 ],
					"text" : "vcompand is a simple vector-based compander. intended for use with FFT bins, you can set a compression threshold, above which the amplitude in each bin will be attenuated by the compression ratio. or, you can specify an expansion threshold, below which the amplitude in each bin will be decreased by the expansion ratio. useful for noise reduction, or highlighting noise, or frequency sensitive compression",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 454.0, 589.0, 140.0, 87.0 ],
					"pic" : "percolate.jpg"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 272.0, 681.0, 322.0, 36.0 ],
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 121.0, 212.0, 64.0, 212.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 216.5, 219.0, 95.5, 219.0 ],
					"source" : [ "obj-24", 0 ]
				}
