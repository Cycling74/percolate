...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 177.0, 48.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 177.0, 82.0, 69.0, 22.0 ],
									"text" : "cycle~ 10."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 87.0, 82.0, 77.0, 22.0 ],
									"text" : "cycle~ 100."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 28.0, 82.0, 46.0, 22.0 ],
									"text" : "sig~ 1"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 70.0, 118.0, 52.0, 22.0 ],
									"text" : "waffle~"
								}
...
, 							{
								"box" : 								{
									...
									"parameter_enable" : 1,
									"patching_rect" : [ 28.0, 153.0, 136.0, 48.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 28.0, 211.0, 45.0, 45.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 4.0, 4.0, 406.0, 33.0 ],
									"text" : "• strange doppleresque pwm effects can be made if you exploit that waffle~ drives one output low (0.) whenever the other outlet is active."
								}
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"midpoints" : [ 37.5, 111.0, 79.5, 111.0 ],
									"source" : [ "obj-19", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 186.5, 112.0, 112.5, 112.0 ],
									"source" : [ "obj-21", 0 ]
								}
...
,
					"patching_rect" : [ 308.0, 228.0, 99.0, 23.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 4.0, 4.0, 517.0, 33.0 ],
									"text" : "• you can also use waffle~ in conjunction with flip~ in the signal network shown below to create a spectral crossover function using the fft~ and ifft~ objects..."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 132.0, 339.0, 45.0, 45.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "signal", "signal", "", "float", "list" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 276.0, 272.0, 136.0, 48.0 ],
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
											"parameter_initial" : [ 0.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "signal", "signal", "", "float", "list" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 132.0, 272.0, 136.0, 48.0 ],
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
											"parameter_initial" : [ 0.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 276.0, 238.0, 97.0, 22.0 ],
									"text" : "ifft~ 1024 1024"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "signal", "signal", "signal" ],
									"patching_rect" : [ 132.0, 238.0, 97.0, 22.0 ],
									"text" : "ifft~ 1024 1024"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 193.0, 150.0, 70.0, 22.0 ],
									"text" : "flip~ 511.5"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 25.0, 112.0, 117.0, 24.0 ],
									"text" : "• crossover bin."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 149.0, 150.0, 35.0, 22.0 ],
									"text" : "sig~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "signal" ],
									"patching_rect" : [ 132.0, 203.0, 53.0, 22.0 ],
									"text" : "waffle~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "signal", "signal", "signal" ],
									"patching_rect" : [ 133.0, 80.0, 94.0, 22.0 ],
									"text" : "fft~ 1024 1024"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 133.0, 45.0, 49.0, 22.0 ],
									"text" : "noise~"
								}
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"midpoints" : [ 202.5, 197.0, 175.5, 197.0 ],
									"source" : [ "obj-11", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 175.5, 231.0, 285.5, 231.0 ],
									"source" : [ "obj-26", 1 ]
								}
...
,
					"patching_rect" : [ 308.0, 188.0, 130.0, 23.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 298.0, 122.0, 150.0, 55.0 ],
					"text" : "• other (more useful?) examples..."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 25.5, 122.0, 150.0, 55.0 ],
					"text" : "• an obnoxious periodic signal switcher..."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 178.0, 154.0, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 178.0, 188.0, 62.0, 23.0 ],
					"text" : "cycle~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 114.5, 188.0, 49.0, 23.0 ],
					"text" : "sig~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 25.5, 188.0, 77.0, 23.0 ],
					"text" : "cycle~ 220."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 98.0, 228.0, 52.0, 23.0 ],
					"text" : "waffle~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "signal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 56.0, 263.0, 136.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_initial" : [ 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 56.0, 321.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "• waffle~ takes an input signal in its left inlet, a crossover signal in its middle inlet, and a sync signal in its right inlet. if the sync signal is below the crossover signal, the input is put out the left outlet... otherwise, the signal is put out the right outlet.",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 458.5, 288.0, 140.0, 87.0 ],
					"pic" : "percolate.jpg"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 188.5, 377.0, 410.0, 21.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 35.0, 219.0, 107.5, 219.0 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 2 ],
					"midpoints" : [ 187.5, 219.0, 140.5, 219.0 ],
					"source" : [ "obj-8", 0 ]
				}
		...
		"parameters" : 		{
			"obj-29::obj-14" : [ "live.gain~[1]", "live.gain~", 0 ],
			"obj-29::obj-17" : [ "live.gain~[2]", "live.gain~", 0 ],
			"obj-34::obj-32" : [ "live.gain~[3]", "live.gain~", 0 ],
