...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 377.0, 512.0, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 311.0, 512.0, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 245.0, 512.0, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 179.0, 512.0, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 393.0, 374.0, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 296.0, 345.0, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 27.0, 204.0, 47.0, 23.0 ],
					"text" : "noise~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 27.0, 232.0, 53.0, 23.0 ],
					"text" : "*~ 0.2"
				}
...
, 			{
				"box" : 				{
					"id" : "obj-6",
					"items" : [ "peaknotch", ",", "lowshelf", ",", "highshelf" ],
					"labelclick" : 1,
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 377.0, 545.0, 85.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 468.0, 258.0, 66.0, 23.0 ],
					"text" : "highshelf"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 470.5, 231.0, 61.0, 23.0 ],
					"text" : "lowshelf"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 466.0, 204.0, 71.0, 23.0 ],
					"text" : "peaknotch"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 393.0, 340.0, 90.0, 23.0 ],
					"text" : "clearsettings"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 492.0, 340.0, 136.0, 25.0 ],
					"text" : "clear bank settings"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 179.0, 476.0, 217.0, 23.0 ],
					"text" : "unpack 1. 1. 1. 1"
				}
...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.831373, 0.627451, 0.321569, 1.0 ],
					"fontname" : "Arial",
					"fontsize" : 13.0,
					"format" : 6,
					"id" : "obj-17",
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 241.0, 176.0, 65.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 241.0, 204.0, 65.0, 23.0 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 546.0, 231.0, 332.0, 23.0 ],
					"text" : "expr 100.*(pow(1000.\\, ($f1/1000.)) - 1.)/( 999.) + 0.0001"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 546.0, 204.0, 310.0, 23.0 ],
					"text" : "expr 2.*(pow(100.\\, ($f1/127.)) - 1.)/( 99.) + 0.000001"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 546.0, 176.0, 271.0, 23.0 ],
					"text" : "expr 18000.*(pow(100.\\, ($f1*.001)) - 1.)/( 99.)"
				}
...
, 			{
				"box" : 				{
					"id" : "obj-4",
					"knobcolor" : [ 0.8, 0.54902, 0.54902, 1.0 ],
					"maxclass" : "slider",
					"numinlets" : 1,
					"numoutlets" : 1,
					"orientation" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 310.5, 203.0, 146.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 241.0, 231.0, 65.0, 23.0 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 310.5, 231.0, 146.0, 23.0 ],
					"size" : 1000.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 310.5, 176.0, 146.0, 23.0 ],
					"size" : 1000.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 199.0, 176.0, 38.0, 25.0 ],
					"text" : "cf"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 128.0, 204.0, 109.0, 25.0 ],
					"text" : "bw (mult of cf)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 128.0, 232.0, 108.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 393.0, 311.0, 41.0, 23.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 393.0, 404.0, 104.0, 23.0 ],
					"text" : "currentbank $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 296.0, 374.0, 44.0, 23.0 ],
					"text" : "* 250."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 359.0, 311.0, 23.0, 146.0 ],
					"size" : 500.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 241.0, 258.0, 65.0, 23.0 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 546.0, 258.0, 271.0, 23.0 ],
					"text" : "expr 18000.*(pow(100.\\, ($f1*.001)) - 1.)/( 99.)"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 310.5, 258.0, 146.0, 23.0 ],
					"size" : 1000.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 104.0, 258.0, 132.0, 25.0 ],
					"text" : "test response freq"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 6,
					"numoutlets" : 4,
					"outlettype" : [ "signal", "signal", "list", "float" ],
					"patching_rect" : [ 27.0, 311.0, 288.0, 23.0 ],
					"text" : "gQ~ 12"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0, 151.5, 65.0, 40.0 ],
					"text" : "Noise out"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 207.5, 400.0, 146.5, 54.0 ],
					"text" : "amplitude of response frequency with current settings."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 505.0, 375.0, 180.0, 83.0 ],
					"text" : "choose which bank's parameters to manipulate. gQ~'s optional argument specifies how many filters to use (in series)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 450.0, 311.0, 121.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 190.5, 557.042479999999955, 159.0, 40.0 ],
					"text" : "current bank filter settings"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 466.0, 144.0, 71.0, 55.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 27.0, 576.042479999999955, 136.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 27.0, 634.042479999999955, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 62.0, 607.0, 79.0 ],
					"text" : "• gQ~ is the msp implementation of dan's gQ equalizer for silicon graphics workstations. you control the center frequency, bandwidth, and boost of the filter. an additional inlet is given to test the response of the filter at a given frequency. gQ was one of the first digital eq filters to work in realtime. one of the nice features of the filter is that it completely decouples the three primary parameters, so adjusting one won't affect the others (this is actually quite tricky, and most filters of this type have coupled parameters)",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 536.0, 589.0, 140.0, 87.0 ],
					"pic" : "percolate.jpg"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 354.0, 681.0, 322.0, 36.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 215.833333333333343, 383.0, 188.5, 383.0 ],
					"source" : [ "obj-50", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 126.166666666666671, 567.0, 153.5, 567.0 ],
					"source" : [ "obj-50", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 36.5, 297.0, 90.299999999999997, 297.0 ],
					"order" : 0,
					"source" : [ "obj-54", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-50", 0 ],
					"midpoints" : [ 36.5, 299.0, 36.5, 299.0 ],
					"order" : 1,
					"source" : [ "obj-54", 0 ]
				}
