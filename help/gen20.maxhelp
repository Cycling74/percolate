...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"fontsize" : 12.0,
					"id" : "obj-3",
					"items" : [ "even", ",", "low", ",", "high", ",", "triangle", ",", "gaussian", ",", "cauchy" ],
					"labelclick" : 1,
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 273.0, 215.0, 73.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 23.0, 276.0, 43.0, 23.0 ],
					"text" : "$1 20"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 23.0, 305.0, 38.0, 23.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 388.0, 146.0, 64.0, 23.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 23.0, 336.0, 61.0, 23.0 ],
					"text" : "phasor~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 148.0, 245.0, 31.0, 23.0 ],
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 273.0, 245.0, 53.0, 23.0 ],
					"text" : "s randit"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 148.0, 215.0, 51.0, 23.0 ],
					"text" : "r randit"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 273.0, 181.0, 29.5, 23.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 148.0, 336.0, 50.0, 23.0 ],
					"text" : "set bar"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 23.0, 370.0, 158.0, 23.0 ],
					"text" : "wave~ bar 0. 185.759644"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 169.0, 305.0, 69.0, 23.0 ],
					"text" : "peek~ bar"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 273.0, 146.0, 99.0, 23.0 ],
					"text" : "buffer~ bar 186"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 169.0, 276.0, 90.0, 23.0 ],
					"text" : "gen20 8192 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 353.0, 206.0, 99.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 23.0, 404.042480000000012, 136.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 23.0, 462.042480000000012, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 62.0, 473.0, 79.0 ],
					"text" : "• gen20 -- give it an int and it will generate an array of random numbers according to one of six probability algorithms (corresponding to the int... they're listed in the umenu on the right). arguments are buffer size (default 512) and offset into output buffer (default 0). you can change this with size N and offset N. ported from real-time cmix, by brad garton and dave topper.",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 358.0, 417.0, 140.0, 87.0 ],
					"pic" : "percolate.jpg"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 121.0, 509.0, 377.0, 21.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-25", 0 ],
					"midpoints" : [ 157.5, 365.0, 32.5, 365.0 ],
					"source" : [ "obj-5", 0 ]
				}
