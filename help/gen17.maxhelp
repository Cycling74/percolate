...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 23.0, 372.0, 52.0, 23.0 ],
					"text" : "*~ 0.99"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 23.0, 277.0, 43.0, 23.0 ],
					"text" : "$1 20"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 23.0, 308.0, 38.0, 23.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 23.0, 146.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 479.0, 146.0, 64.0, 23.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 23.0, 181.0, 112.0, 23.0 ],
					"text" : "tempo 120 1 16"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 23.0, 246.0, 36.0, 23.0 ],
					"text" : "mtof"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 23.0, 340.0, 48.0, 23.0 ],
					"text" : "cycle~"
				}
...
,
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 23.0, 215.0, 50.5, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 148.0, 277.0, 35.0, 23.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 354.0, 370.0, 55.0, 23.0 ],
					"text" : "s cheby"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 148.0, 246.0, 53.0, 23.0 ],
					"text" : "r cheby"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 354.0, 174.0, 202.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 354.0, 202.0, 123.0, 23.0 ],
					"text" : "0. 0. 2. 0.5 0. 0.1 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 354.0, 230.0, 130.0, 23.0 ],
					"text" : "0. 1. 0. 0.5 0. 0.25 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 354.0, 258.0, 72.0, 23.0 ],
					"text" : "0. 1. 0. 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 354.0, 286.0, 151.0, 23.0 ],
					"text" : "1. 0.7 0.7 0.7 0.7 0.7 0.7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 354.0, 315.0, 151.0, 23.0 ],
					"text" : "1. 0.5 0.9 0.4 0.8 0.3 0.7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 353.0, 343.0, 209.0, 23.0 ],
					"text" : "1. 0.1 0.5 0.333 0.25 0.666 0.0125"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 148.0, 340.0, 50.0, 23.0 ],
					"text" : "set bar"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 23.0, 405.0, 122.0, 23.0 ],
					"text" : "lookup~ bar 0 8192"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 208.0, 340.0, 69.0, 23.0 ],
					"text" : "peek~ bar"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 353.0, 146.0, 99.0, 23.0 ],
					"text" : "buffer~ bar 186"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 208.0, 308.0, 90.0, 23.0 ],
					"text" : "gen17 8192 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 497.0, 202.0, 101.0, 112.0 ],
					"text" : "• list of amplitudes of successive harmonics (begins with fundamental)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 51.0, 146.0, 121.0, 25.0 ],
					"text" : "• start sequence"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 23.0, 439.042480000000012, 136.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 23.0, 497.042480000000012, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 62.0, 624.0, 79.0 ],
					"text" : "• gen17 -- give it a list of harmonic partial amplitudes and it will put out index/amplitude pairs that you can peek~ into a buffer~ to use with lookup~'s transfer function. solves chebyshev polynomials. arguments are buffer size (default 512) and offset into output buffer (default 0). you can change these with size N and offset N. the rescale N message turns on and off array rescaling. by default, the array is rescaled to fit between -1 and 1. ported from real-time cmix, by brad garton and dave topper.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 3.0, 144.0, 60.0 ],
					"text" : "gen17",
					"textcolor" : [ 0.2, 0.2, 0.2, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 488.0, 452.0, 140.0, 87.0 ],
					"pic" : "percolate.jpg"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 251.0, 544.0, 377.0, 21.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-25", 0 ],
					"midpoints" : [ 157.5, 399.0, 32.5, 399.0 ],
					"source" : [ "obj-5", 0 ]
				}
