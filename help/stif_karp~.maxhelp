...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 46.581818181818164, 333.0, 57.0, 23.0 ],
					"text" : "noteoff"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 7.981818181818255, 304.0, 96.0, 23.0 ],
					"text" : "noteon $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 7.981818181818255, 276.0, 74.0, 23.0 ],
					"text" : "pack 1. 1."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 150.481818181818255, 353.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 322.363636363636545, 353.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 238.481818181818255, 353.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 150.481818181818255, 384.5, 76.0, 23.0 ],
					"text" : "control 1 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 322.363636363636545, 384.5, 83.0, 23.0 ],
					"text" : "control 11 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 238.481818181818255, 384.5, 76.0, 23.0 ],
					"text" : "control 4 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 7.981818181818255, 433.0, 61.0, 22.0 ],
					"text" : "stif_karp~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 422.899999999999977, 186.75, 73.0, 21.0 ],
					"text" : "Try presets",
...
,
					"patching_rect" : [ 7.981818181818255, 161.75, 185.699999999999989, 86.5 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 497.900000000000034, 204.25, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 427.900000000000034, 209.75, 57.0, 16.5 ],
					"preset_data" : [ 						{
							"number" : 1,
							"data" : [ 5, "obj-24", "number", "int", 33, 5, "obj-32", "number", "int", 34, 5, "obj-21", "number", "int", 34 ]
						}
, 						{
							"number" : 2,
							"data" : [ 5, "obj-24", "number", "int", 92, 5, "obj-32", "number", "int", 80, 5, "obj-21", "number", "int", 7 ]
						}
, 						{
							"number" : 3,
							"data" : [ 5, "obj-24", "number", "int", 49, 5, "obj-32", "number", "int", 35, 5, "obj-21", "number", "int", 58 ]
						}
, 						{
							"number" : 4,
							"data" : [ 5, "obj-24", "number", "int", 4, 5, "obj-32", "number", "int", 3, 5, "obj-21", "number", "int", 102 ]
						}
 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 153.381818181818346, 466.5, 114.0, 25.0 ],
					"text" : "turn up volume"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 58.381818181818346, 533.5, 79.0, 25.0 ],
					"text" : "start dsp"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 8.381818181818346, 523.5, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-33",
					"ignoreclick" : 1,
					"jsarguments" : [ "stif_karp~" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 5.699999999999989, 8.0, 544.0, 132.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 269.381818181818346, 469.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "2",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 139.881818181818346, 536.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 400.327272727272714, 186.75, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "4",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 258.581818181818164, 228.25, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "3",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-39", 0 ],
					"midpoints" : [ 159.981818181818255, 418.0, 17.481818181818255, 418.0 ],
					"source" : [ "obj-35", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-39", 0 ],
					"midpoints" : [ 331.863636363636545, 418.0, 17.481818181818255, 418.0 ],
					"source" : [ "obj-36", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-39", 0 ],
					"midpoints" : [ 247.981818181818255, 418.0, 17.481818181818255, 418.0 ],
					"source" : [ "obj-37", 0 ]
				}
